    ...
    return (
        <SafeAreaView>
            <View style={styles.container}>
                ...
                <FlatList showsHorizontalScrollIndicator style={styles.list} horizontal data={categories} renderItem={renderCategoryItem} keyExtractor={(item, index) => String(index)}/>
